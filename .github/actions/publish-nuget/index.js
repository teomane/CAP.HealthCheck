...
class Action {
    constructor() {
        ...
        this.versionSuffix = process.env.INPUT_VERSION_SUFFIX
    ...
    _pushPackage(version, name) {
        ...
        this._executeInProcess(`dotnet pack -p:PackageVersion=${version} ${this.includeSymbols ? "--include-symbols -p:SymbolPackageFormat=snupkg" : ""} --no-build -c Release ${this.projectFile} -o .`)
